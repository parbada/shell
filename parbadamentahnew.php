...
<head>
    ...
    <style>
        body{
            margin: 0;
            padding: 0;
            background-image:  url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhltrwCLUdudo4OXYyyn51V0QAJMP3KhPrcDh3g68ei6LUjLe5MFC0cvwokgN-s8IjoSOWQgFSo-V7oQX1e09ROGsNidv9i_s5n7kaIrswvdE_z4EEI1M2IKqq7s3VdW53By6WMG-JgCST1F32u48fCjZ1nnQCpaU23G5Z0GdOoZqZajciTMNiAJLk8KXM/s16000/srepp.png);
            background-color: #222;
        }
        @import url('https://fonts.googleapis.com/css2?family=Permanent+Marker&family=Signika:wght@300..700&display=swap');
...
input[type="submit"]{
    ...
    font-weight: 600;
    font-size: 16px;
    background-image: linear-gradient(90deg, #222, #0d0d0d);
    border: none;
    color: #e0dddd;
...
<body>
<div class="container">
    <h3 class="position-absolute">Parbada</h3>
    <p style="margin-top: 10em; font-size: 12px; color: rgb(182, 186, 189);" class="position-absolute">~ Banyak Kali Cakap Kelen !!! ~</p>
    <div class="screen">
        <form action="" method="post">
            <input id="search" class="searchbar" type="password" name="pass" placeholder="Password">
